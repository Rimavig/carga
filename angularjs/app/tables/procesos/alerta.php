...
if (isset($_POST["localidadG"])) {
    ...
    if ( $tipo=="boletos"){
        ...
        if ( isset($_POST["editar"])){
            ...
            $re = $client->updatePromocion($idPromocion,$idPromocion2,$nombre,$descripcion,$estado,$id_evento,$id_platea,$id_funcion,$localidadG,$localidadW,$localidadA,$localidadT,$categoria,$fechaI,$fechaT,$tipo,$desde,$hasta,$descuento,$Cmaxima,"",$_SESSION["usuario"],$CmaximaT); 
        }else{
            $re = $client->insertPromocion($nombre,$descripcion,$estado,$id_evento,$id_platea,$id_funcion,$localidadG,$localidadW,$localidadA,$localidadT,$categoria,$fechaI,$fechaT,$tipo,$desde,$hasta,$descuento,$Cmaxima,"",$_SESSION["usuario"],$CmaximaT); 
        }
        $resultado = "".$re;
    }else if ( $tipo=="Fpago"){
        $compra=$_POST["compra"];
        ...
        if ( isset($_POST["editar"])){
            $idPromocion=$_POST["idPromocion"];
            $idPromocion2=$_POST["idPromocion2"];
            $re = $client->updatePromocion($idPromocion,$idPromocion2,$nombre,$descripcion,$estado,$id_evento,$id_platea,$id_funcion,$localidadG,$localidadW,$localidadA,$localidadT,$categoria,$fechaI,$fechaT,$tipo,$compra,$pago,"",$Cmaxima,"",$_SESSION["usuario"],$CmaximaT);
        }else{
            $re = $client->insertPromocion($nombre,$descripcion,$estado,$id_evento,$id_platea,$id_funcion,$localidadG,$localidadW,$localidadA,$localidadT,$categoria,$fechaI,$fechaT,$tipo,$compra,$pago,"",$Cmaxima,"",$_SESSION["usuario"],$CmaximaT);
        }
        $resultado = "".$re;
        ...
        if ( isset($_POST["editar"])){
            $idPromocion=$_POST["idPromocion"];
            $idPromocion2=$_POST["idPromocion2"];
            $re = $client->updatePromocion($idPromocion,$idPromocion2,$nombre,$descripcion,$estado,$id_evento,$id_platea,$id_funcion,$localidadG,$localidadW,$localidadA,$localidadT,$categoria,$fechaI,$fechaT,$tipo,$tarjeta,$banco,$descuento,$Cmaxima,"",$_SESSION["usuario"],$CmaximaT); 
        }else{
            $re = $client->insertPromocion($nombre,$descripcion,$estado,$id_evento,$id_platea,$id_funcion,$localidadG,$localidadW,$localidadA,$localidadT,$categoria,$fechaI,$fechaT,$tipo,$tarjeta,$banco,$descuento,$Cmaxima,"",$_SESSION["usuario"],$CmaximaT); 
        }
        $resultado = "".$re;
        ...
        if ( isset($_POST["editar"])){
            $idPromocion=$_POST["idPromocion"];
            $idPromocion2=$_POST["idPromocion2"];
            $re = $client->updatePromocion($idPromocion,$idPromocion2,$nombre,$descripcion,$estado,$id_evento,$id_platea,$id_funcion,$localidadG,$localidadW,$localidadA,$localidadT,$categoria,$fechaI,$fechaT,$tipo,$codigo,"",$descuento,$Cmaxima,"",$_SESSION["usuario"],$CmaximaT);
        }else{
            $re = $client->insertPromocion($nombre,$descripcion,$estado,$id_evento,$id_platea,$id_funcion,$localidadG,$localidadW,$localidadA,$localidadT,$categoria,$fechaI,$fechaT,$tipo,$codigo,"",$descuento,$Cmaxima,"",$_SESSION["usuario"],$CmaximaT);
        }        
        $resultado = "".$re;
        ...
        if ( isset($_POST["editar"])){
            $idPromocion=$_POST["idPromocion"];
            $idPromocion2=$_POST["idPromocion2"];
            $re = $client->updatePromocion($idPromocion,$idPromocion2,$nombre,$descripcion,$estado,$id_evento,$id_platea,$id_funcion,$localidadG,$localidadW,$localidadA,$localidadT,$categoria,$fechaI,$fechaT,$tipo,$id_evento2,$cantidad1,$cantidad2,$Cmaxima,$descuento,$_SESSION["usuario"],$CmaximaT);
        }else{
            $re = $client->insertPromocion($nombre,$descripcion,$estado,$id_evento,$id_platea,$id_funcion,$localidadG,$localidadW,$localidadA,$localidadT,$categoria,$fechaI,$fechaT,$tipo,$id_evento2,$cantidad1,$cantidad2,$Cmaxima,$descuento,$_SESSION["usuario"],$CmaximaT);
        }        
        $resultado = "".$re;
    }
