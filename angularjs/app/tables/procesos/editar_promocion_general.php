        ...
        <div class="modal-body">
            <form role="form" class=" form-validation">
                ...
                <div class="row"> 
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            <label for="field-1" class="control-label">Cant Máx Usuario</label>
                            <div class="form-group ">
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            <label for="field-1" class="control-label">Cant Máx Usada</label>
                            <div class="form-group ">
                                <input class="form-control input-sm" id="CmaximaU" type="number" value="<?php echo $CmaximoU; ?>" min="0" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
                            <label for="field-1" class="control-label">Cant Máx Total</label>
                            <div class="form-group ">
                                <input class="form-control input-sm" id="CmaximaT"  value="<?php echo $CmaximoT; ?>" type="number" value="0" min="0" required>
                            </div>
                        </div>
                    </div> 
                </div>
