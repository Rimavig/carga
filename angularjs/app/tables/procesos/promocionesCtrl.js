  ...
  .controller('promocionesCtrl', ['$scope','pluginsService','$location','$route', function ($scope ,pluginsService, $location,$route) {
    ...
    $scope.$on('$viewContentLoaded', function () {
        ...
        $(document).on('click', '.crear_promocion_general', function (e) {
            ...
            var CmaximaT=$(this).parents().find('#CmaximaT')[0].value;
            ...
            if(CmaximaT<0){
                $(this).prop("disabled",true); 
                var n = noty({
                    text        : '<div class="alert alert-warning "><p><strong>Ingrese una cantidad total válida </p></div>',
                    layout      : 'topCenter', //or left, right, bottom-right...
                    theme       : 'made',
                    type        : 'error',
                    maxVisible  : 5,
                ...
                if (  tipo=="none"){
                    ...
                    if(band2){
                        ...
                        $('#alerta').load('./tables/procesos/alerta.php',{id_evento:"1", id_platea:"1",id_funcion:"1",categoria:categoria, nombre:nombre, descripcion:descripcion, fechaI:fechaI,fechaT:fechaT,amigos:amigos,localidadG:localidadG,
                            localidadW:localidadW,localidadA:localidadA,localidadT:localidadT,tipo:tipo, desde:desde, hasta:hasta, descuento:descuento, Cmaxima:Cmaxima, CmaximaT:CmaximaT},function() {    
                            $('.page-spinner-loader').addClass('hide');
                        });
                    }else{
                        $(this).prop("disabled",false);
                    ...
                    if(band2){
                        $('.page-spinner-loader').removeClass('hide');
                        $('#alerta').load('./tables/procesos/alerta.php',{id_evento:"1", id_platea:"1",id_funcion:"1",categoria:categoria, nombre:nombre, descripcion:descripcion, fechaI:fechaI,fechaT:fechaT,amigos:amigos,localidadG:localidadG,
                            localidadW:localidadW,localidadA:localidadA,localidadT:localidadT,tipo:tipo, compra:compra, pago:pago, Cmaxima:Cmaxima, CmaximaT:CmaximaT},function() {    
                            $('.page-spinner-loader').addClass('hide');
                        });
                    }else{
                        $(this).prop("disabled",false);
                    ...
                    if(band2){
                        $('.page-spinner-loader').removeClass('hide');
                        $('#alerta').load('./tables/procesos/alerta.php',{id_evento:"1", id_platea:"1",id_funcion:"1",categoria:categoria, nombre:nombre, descripcion:descripcion, fechaI:fechaI,fechaT:fechaT,amigos:amigos,localidadG:localidadG,
                            localidadW:localidadW,localidadA:localidadA,localidadT:localidadT,tipo:tipo, tarjeta:tarjeta, banco:banco, descuento:descuento, Cmaxima:Cmaxima, CmaximaT:CmaximaT},function() {    
                            $('.page-spinner-loader').addClass('hide');
                        });
                    }else{
                        $(this).prop("disabled",false);
                    ...
                    if(band2){
                        $('.page-spinner-loader').removeClass('hide');
                        $('#alerta').load('./tables/procesos/alerta.php',{id_evento:"1", id_platea:"1",id_funcion:"1",categoria:categoria, nombre:nombre, descripcion:descripcion, fechaI:fechaI,fechaT:fechaT,amigos:amigos,localidadG:localidadG,
                            localidadW:localidadW, localidadA:localidadA, localidadT:localidadT, tipo:tipo, codigo:codigo, descuento:descuento, Cmaxima:Cmaxima,CmaximaT:CmaximaT},function() {    
                            $('.page-spinner-loader').addClass('hide');
                        });
                    }else{
                        $(this).prop("disabled",false);
            ...
            if(band){
                if (  tipo=="none"){
                    ...
                    if(band2){
                        $('.page-spinner-loader').removeClass('hide');
                        $('#alerta').load('./tables/procesos/alerta.php',{promo:"T",id_evento:id, id_platea:platea, id_funcion:funcion,categoria:categoria, nombre:nombre, descripcion:descripcion, fechaI:fechaI,fechaT:fechaT,amigos:amigos,localidadG:localidadG,
                            localidadW:localidadW, localidadA:localidadA, localidadT:localidadT, tipo:tipo, cantidad1:cantidad1, id_evento2:id_evento2, cantidad2:cantidad2, Cmaxima:Cmaxima,  CmaximaT:CmaximaT, descuento:descuento},function() {    
                            $('.page-spinner-loader').addClass('hide');
                        });
                    }else{
                        $(this).prop("disabled",false);
