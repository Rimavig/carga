            ...
            $('.table-dynamic').each(function () {
                ...
                if(lon==1){
                    if ($(this).hasClass('bloqueados_data')) {
                        ...
                        carga="tables/usuarios/usuarios-clientes_data.php?var1="+txt;
                    }else if ($(this).hasClass('clientes_dataR2')) {
                        var txt=$(this).data('table-fechai'); 
                        carga="tables/usuarios/usuarios-clientes_data2.php?var1="+txt;
                    }else if ($(this).hasClass('clientes_dataR')) {
                        var txt=$(this).data('table-fechai'); 
                        carga="tables/reportes/usuarios-clientes_data.php?var1="+txt;
                    ...
                    if ($(this).hasClass('cortesia')) {
                        table =$(this).dataTable({
                            ...
                            "aoColumnDefs": [
                                ...
                                { "sWidth": "10%", "className": "text-center", "aTargets": [ 1,4,6,9,10]},
                                { "sWidth": "20%", "className": "text-center", "aTargets": [ 2]},
