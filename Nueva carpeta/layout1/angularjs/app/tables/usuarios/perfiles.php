                ...
                <div class="panel">
                    ...
                    <div class="panel-content pagination2 table-responsive">
                        ...
                        <accordion class="panel-group panel-accordion" close-others="true">
                            ...
                            <accordion-group is-open="open10">
                                <accordion-heading>
                                    Módulo <strong>Cafe Vino Bar</strong><i class="pull-right glyphicon" ng-class="{'glyphicon-chevron-down': open10, 'glyphicon-chevron-right': !open10}"> </i>
                                </accordion-heading>
                                <div class="panel-body cafe-vino-bar">
