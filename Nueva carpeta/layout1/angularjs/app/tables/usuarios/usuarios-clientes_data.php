...
$re = $client9->getAllUsuarioCliente($varF);
$resultado= "".$re;
...
//$dataT['draw']=$_GET["draw"]; 
 
//$valor=$_GET["start"];  
//$dataT['recordsTotal']=$_GET["length"];   
//$dataT['recordsFiltered']=sizeof($data);   
//dataT['valor']=$valor;   
//$dataT['data']=array_slice($data, $valor, $_GET["length"]);;   
$dataT['data']=$data;   
