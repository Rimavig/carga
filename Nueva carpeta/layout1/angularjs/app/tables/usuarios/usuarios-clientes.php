        ...
        <div class="col-lg-12 portlets">
            <div class="panel">
                ...
                <div class="panel-content pagination2 table-responsive">
                    ...
                    <table class="table clientes_data <?php echo $exportar; ?> table-dynamic table-tools1C " data-table-fechai="<?php echo "buscar"; ?>" data-table-name="Usuarios" id="table-editable" style="table-layout: fixed;">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Nombres</th>
