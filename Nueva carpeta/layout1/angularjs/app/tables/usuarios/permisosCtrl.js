    ...
    $scope.$on('$viewContentLoaded', function () {
        ...
        $(document).on('change','#admin' ,function(e) {
            ...
            if(this.checked) {
                ...
                $(this).parents().find('#CVInventarioGrupo').iCheck('check');
                $(this).parents().find('#CVInventarioItem').iCheck('check');
                $(this).parents().find('#CVInventarioCompuesto').iCheck('check');
                $(this).parents().find('#CVStockProveedor').iCheck('check');
                $(this).parents().find('#CVStockIngreso').iCheck('check');
                $(this).parents().find('#CVStockEgreso').iCheck('check');
                $(this).parents().find('#CVStockOrdenCompra').iCheck('check');
                $(this).parents().find('#CVPromocionesGeneral').iCheck('check');
                $(this).parents().find('#CVPromocionesItem').iCheck('check');
                $(this).parents().find('#CVPromocionesCompuesto').iCheck('check');
        ...
        //MODULO CAFE VINO BAR
        seleccionar('#CVInventarioGrupo','CVIG');
        seleccionar('#CVInventarioItem','CVII');
        seleccionar('#CVInventarioCompuesto','CVIC');
        seleccionar('#CVStockProveedor','CVSP');
        seleccionar('#CVStockIngreso','CVSI');
        seleccionar('#CVStockEgreso','CVSE');
        seleccionar('#CVStockOrdenCompra','CVSC');
        seleccionar('#CVPromocionesGeneral','CVPG');
        seleccionar('#CVPromocionesItem','CVPI');
        seleccionar('#CVPromocionesCompuesto','CVPC');
        ...
        $(document).on('click', '.crear_perfil', function (e) {
            ...
            //MODULO CAFE VINO BAR
            permisos=permisos +verificar('#CVInventarioGrupo','CVIG');
            permisos=permisos +verificar('#CVInventarioItem','CVII');
            permisos=permisos +verificar('#CVInventarioCompuesto','CVIC');
            permisos=permisos +verificar('#CVStockProveedor','CVSP');
            permisos=permisos +verificar('#CVStockIngreso','CVSI');
            permisos=permisos +verificar('#CVStockEgreso','CVSE');
            permisos=permisos +verificar('#CVPromocionesGeneral','CVPG');
            permisos=permisos +verificar('#CVPromocionesItem','CVPI');
            permisos=permisos +verificar('#CVPromocionesCompuesto','CVPC');
        ...
        $(document).on('click', '.crearPerfil', function (e) {
            ...
            $('.cafe-vino-bar').load('./tables/usuarios/modulo_cafe_vino_bar.php',function() {    
                $('.page-spinner-loader').addClass('hide');
                handleiCheck();
            });
            $(this).prop("disabled",false);
        ...
        $(document).on('click', '.editarPerfil', function (e) {
            ...
            $('.cafe-vino-bar').load('./tables/usuarios/modulo_cafe_vino_bar.php',{var1:estado.innerHTML},function() {    
                $('.page-spinner-loader').addClass('hide');
                handleiCheck();
            });
            $(this).prop("disabled",false);
        ...
        $(document).on('click', '.editar_perfil', function (e) {
            ...
            permisos=permisos +verificar('#CVStockIngreso','CVSI');
            permisos=permisos +verificar('#CVStockEgreso','CVSE');
            permisos=permisos +verificar('#CVStockOrdenCompra','CVSC');
            permisos=permisos +verificar('#CVPromocionesGeneral','CVPG');
            permisos=permisos +verificar('#CVPromocionesItem','CVPI');
            permisos=permisos +verificar('#CVPromocionesCompuesto','CVPC');
            var band=true;
