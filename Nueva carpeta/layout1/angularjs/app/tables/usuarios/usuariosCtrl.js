...
angular.module("newApp").controller("usuariosCtrl", [
  "$scope",
  "pluginsService",
  function ($scope, pluginsService) {
    ...
    $scope.$on("$viewContentLoaded", function () {
      ...
      $(document).on("click", ".editar", function (e) {
        ...
        $("#Cusuarios").load(
          "./tables/usuarios/editar_usuario.php",
          { var1: estado.innerHTML, tipo: "admin" },
          function () {
      ...
      $(document).on("click", ".crear", function (e) {
        ...
        $(".page-spinner-loader").removeClass("hide");
        $("#Cusuarios").load(
          "./tables/usuarios/crear_usuario.php",
          { tipo: "admin" },
          function () {
            $(".page-spinner-loader").addClass("hide");
            $("#Cusuarios").modal("show"); // abrir
      ...
      $(document).on("click", ".facturacion", function (e) {
        ...
        var estado = $(this).parents("tr").find(".hide_column")[0];
        $("#factura").load(
          "./tables/usuarios/facturacion.php",
          { var1: estado.innerHTML, tipo: "admin" },
          function () {
            ...
            $("#table-editable1").dataTable({
              ...
              ajax:
                "tables/usuarios/facturacion-data.php?var1=" + estado.innerHTML,
              ordering: false,
              autoWidth: false,
      ...
      $(document).on("click", ".editarC", function (e) {
        ...
        $(".page-spinner-loader").removeClass("hide");
        $("#Cusuarios").load(
          "./tables/usuarios/editar_usuarioClientes.php",
          { var1: estado.innerHTML, tipo: "cliente" },
          function () {
            $(".page-spinner-loader").addClass("hide");
            $("#Cusuarios").modal("show"); // abrir
          }
      ...
      $(document).on("click", ".crearC", function (e) {
        ...
        $(".page-spinner-loader").removeClass("hide");
        $("#Cusuarios").load(
          "./tables/usuarios/crear_usuarioClientes.php",
          { tipo: "cliente" },
          function () {
            $(".page-spinner-loader").addClass("hide");
            $("#Cusuarios").modal("show"); // abrir
      ...
      $(document).on("click", ".correoR", function (e) {
        ...
        $(".page-spinner-loader").removeClass("hide");
        $("#alerta").load(
          "./tables/reportes/alerta.php",
          { tipo: "UclienteV", id: id },
          function () {
            $(".page-spinner-loader").addClass("hide");
          }
        );
      ...
      $(document).on("click", ".editarE", function (e) {
        ...
        $("#Cusuarios").load(
          "./tables/usuarios/editar_usuario.php",
          { var1: estado.innerHTML, tipo: "evento" },
          function () {
            $(".page-spinner-loader").addClass("hide");
            $("#Cusuarios").modal("show"); // abrir
          }
      ...
      $(document).on("click", ".editarF", function (e) {
        ...
        $(".page-spinner-loader").removeClass("hide");
        $("#Cusuarios").load(
          "./tables/usuarios/editar_facturacion.php",
          { var1: estado.innerHTML, tipo: "evento" },
          function () {
            $(".page-spinner-loader").addClass("hide");
            $("#Cusuarios").modal("show"); // abrir
      ...
      $(document).on("click", ".crearF", function (e) {
        ...
        $(".page-spinner-loader").removeClass("hide");
        $("#Cusuarios").load(
          "./tables/usuarios/crear_facturacion.php",
          { var1: id, tipo: "evento" },
          function () {
            $(".page-spinner-loader").addClass("hide");
            $("#Cusuarios").modal("show"); // abrir
