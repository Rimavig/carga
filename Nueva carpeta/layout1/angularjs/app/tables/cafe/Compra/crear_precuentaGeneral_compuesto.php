...
<div class="modal-dialog modal-mantenimiento ">
    <div class="modal-content  ">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><strong>Ingresar</strong> Compuesto</h4>
        </div>
        <div class="modal-body">
            ...
            <div class="modal-footer text-center">
                ...
                <button type="button" class="btn btn-danger btn-embossed crear_precuentaGeneral_compuesto <?php echo $crear; ?>">Guardar</button>
            </div>
        </div>
    </div>
