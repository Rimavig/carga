...
<div class="modal-dialog modal-mantenimiento ">
    <div class="modal-content  ">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><strong>Editar</strong> Item </h4>
            <input type="text" id="EidPrecuentaGeneralItem" class="esconder" value="<?php echo $var1; ?>" disabled>
        ...
        <div class="modal-body">
            ...
            <div class="modal-footer text-center">
                ...
                <button type="button" class="btn btn-danger btn-embossed editar_precuentaGeneral_item <?php echo $crear; ?>">Guardar</button>
            </div>
        </div>
    </div>
