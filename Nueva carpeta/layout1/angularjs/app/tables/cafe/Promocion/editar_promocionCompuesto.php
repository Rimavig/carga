...
<div class="modal-dialog modal-mantenimiento ">
    <div class="modal-content  ">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><strong>Editar</strong> Promoción Compuesto</h4>
            <input type="text"  id="EidPromocionCompuesto" class="esconder"  value="<?php echo $var1; ?>" disabled>    
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control form-white" id="grupoC" data-placeholder="Escoga compuesto" name="compuesto" >
                            <option value="<?php echo $promocionG->id_compuesto ?>" data-precio="<?php echo $promocionG->precio_objeto ?>">
                                <?php echo $promocionG->nombre_compuesto ?>
                            </option>
        ...
        <div class="modal-footer text-center">
            ...
            <button type="button" class="btn btn-danger btn-embossed editar_promocionCompuesto <?php echo $crear; ?>">Editar</button>
        </div>
    </div>
</div>
<?php
