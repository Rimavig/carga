    ...
    <div class="modal-dialog modal-mantenimiento ">
        <div class="modal-content  ">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><strong>Crear</strong> Ingreso Compuesto</h4>
            </div>
            ...
            <div class="modal-footer text-center">
                ...
                <button type="button" class="btn btn-danger btn-embossed crear_ingresoCompuesto <?php echo $crear; ?>">Guardar</button>
            </div>
        </div>
    </div>
    <?php
