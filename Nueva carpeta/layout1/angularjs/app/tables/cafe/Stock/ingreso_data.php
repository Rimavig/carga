...
foreach ($usuarios1 as $llave => $valores1) {
    if ($valores1 === "2") {
        //$editarI = '<a title="Editar" class="editarIngresoItem btn btn-sm btn-dark" style="margin: 5px 0px;  "  href="javascript:;"><i class="icon-note"></i></a>';
        //$editarC = '<a title="Editar" class="editarIngresoCompuesto btn btn-sm btn-dark" style="margin: 5px 0px;  "  href="javascript:;"><i class="icon-note"></i></a>';

    }
    if ($valores1 === "3") {
        $eliminarI = '<a title="Eliminar" class="eliminarIngresoItem btn btn-sm btn-danger" style="margin: 5px 0px;  " href="javascript:;"><i class="icon-trash"></i></a>';
        $eliminarC = '<a title="Eliminar" class="eliminarIngresoCompuesto btn btn-sm btn-danger" style="margin: 5px 0px;  " href="javascript:;"><i class="icon-trash"></i></a>';
    }
}
$busquedaT->tipo = "I";
