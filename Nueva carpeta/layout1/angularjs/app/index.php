...
foreach ($usuarios as $llave => $valores1) {
    ...
    if ($valores1 === "86" || $valores1 === "89" || $valores1 === "90") {
        $CVInventario = "";
        $modulo10 = true;
    }
    if ($valores1 === "87" || $valores1 === "91" || $valores1 === "92" || $valores1 === "93") {
        $CVStock = "";
        $modulo10 = true;
    }
    if ($valores1 === "88" || $valores1 === "94" || $valores1 === "95") {
        $CVPromociones = "";
        $modulo10 = true;
    }
}
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-inner">
                ...
                <ul class="nav nav-sidebar">
                    ...
                    <?php if ($modulo10) { ?>
                        <li class="nav-parent">
                            <a href=""><i class="fa fa-table"></i><span>Cafe Vino Bar</span><span class="fa arrow"></span></a>
                            <ul class="children collapse">
